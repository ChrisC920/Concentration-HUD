...
description: Use when implementing camera streaming or photo capture from Meta glasses with the DAT SDK — covers StreamSession, StreamSessionConfig (resolution, frame rate, codec), VideoFrame, photoDataPublisher, capturePhoto, AutoDeviceSelector, and bandwidth/quality tradeoffs.
---
