...
description: Use when registering an iOS app with Meta AI or requesting DAT SDK device permissions like camera — covers startRegistration, registrationStateStream, handleUrl callbacks, checkPermissionStatus/requestPermission, multi-device permission behavior, and Developer Mode vs production registration.
---
