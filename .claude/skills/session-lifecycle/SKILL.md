...
description: Use when handling DAT SDK device session states (RUNNING/PAUSED/STOPPED), pause/resume behavior, device availability streams, or diagnosing why a session transitioned — covers deviceSessionStateStream, devicesStream, hinge open/close behavior, and the rule against restarting during PAUSED.
---
