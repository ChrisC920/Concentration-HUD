...
description: Use when testing DAT SDK code without physical Meta glasses — covers MockDeviceKit, MockRaybanMeta, MockCameraKit, simulating powerOn/unfold/don/doff lifecycle, setCameraFeed/setCapturedImage for mock video and photos, and writing XCTest base classes that use MWDATMockDevice.
---
