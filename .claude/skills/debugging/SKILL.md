---
name: debugging
description: Use when diagnosing DAT SDK issues — device not connecting, StreamSession stuck in waitingForDevice, registration failures, Developer Mode toggling off after firmware updates, version compatibility between SDK / Meta AI app / glasses firmware, and the known-issues list.
---
