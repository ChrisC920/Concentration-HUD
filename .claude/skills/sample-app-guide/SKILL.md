...
description: Use when scaffolding a complete DAT SDK iOS app or wiring together registration, streaming, and photo capture — provides project structure, SwiftUI app entry point, WearablesViewModel, StreamSessionViewModel, and the allowed MWDATCore/MWDATCamera/MWDATMockDevice dependency set, mirroring the CameraAccess sample.
---
